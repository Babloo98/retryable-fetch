 ...
 */
function retryFetch(_x) {
  return _retryFetch.apply(this, arguments);
}
function _retryFetch() {
  _retryFetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(url) {
    var options,
      retries,
      delay,
      response,
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 17:
          return _context.abrupt("return", retryFetch(url, options, retries - 1, delay * 2));
        case 20:
          throw _context.t0;
        case 21:
        case "end":
